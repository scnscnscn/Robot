...
public:
  ...
  vector<geometry_msgs::PoseStamped> optimizePath(const vector<geometry_msgs::PoseStamped>& path, float safety_distance);
  bool arePointsCollinear(const geometry_msgs::PoseStamped& p1, const geometry_msgs::PoseStamped& p2, const geometry_msgs::PoseStamped& p3);
  bool isPathSafe(const geometry_msgs::PoseStamped& p1, const geometry_msgs::PoseStamped& p2, float safety_distance);
