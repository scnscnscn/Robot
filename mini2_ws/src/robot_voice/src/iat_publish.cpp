...
static void show_result(char *string, char is_over)
{
    ...
    if(is_over)
        ...
        if(commandString.compare("向前进") == 0)
        {
        ...
        else if(commandString.compare("向后退") == 0)
        {
          geometry_msgs::Twist cmd;
          cmd.linear.x = -0.5;
          cmd.angular.z = 0;
        ...
        else if(commandString.compare("向左转") == 0)
        {
          geometry_msgs::Twist cmd;
          cmd.linear.x = 0;
          cmd.angular.z = -0.5;
        ...
        else if(commandString.compare("向右转") == 0)
        {
          geometry_msgs::Twist cmd;
          cmd.linear.x = 0;
          cmd.angular.z = 0.5;
...
int main(int argc, char* argv[])
{
    ...
    string nlu_topic = "/robot_voice/nlu_topic";  //default nlu topic
