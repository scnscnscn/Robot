...
const char * ASR_RES_PATH        = "fo|/home/abot/catkin_ws/src/robot_voice/res/asr/common.jet"; //离线语法识别资源路径
const char * GRM_BUILD_PATH      = "/home/abot/catkin_ws/src/robot_voice/res/asr/GrmBuilld"; //构建离线语法识别网络生成数据保存路径
const char * GRM_FILE            = "/home/abot/catkin_ws/src/robot_voice/res/asr/call.bnf"; //构建离线识别语法网络所用的语法文件
...
void WakeupCb(const std_msgs::String::ConstPtr& msg)
{
    printf("waking up\r\n");
    usleep(700*1000);
    wakeupFlag=1;
...
{
	const char *login_config    = "appid = 6010cacd"; //登录参数
	UserData asr_data; 
	int ret                     = 0 ;
	char c;

    //init ROS//
    ros::init(argc, argv, "asr_offline");
    ros::NodeHandle n;
    ros::Rate loop_rate(10);
    // 订阅唤醒语音识别的信号
    ros::Subscriber wakeUpSub = n.subscribe("/robot_voice/asr_topic", 1000, WakeupCb);
