...
static void show_result(char *string, char is_over)
{
    ...
    if(is_over)
        ...
        if(commandString.compare("红色") == 0)
        {
          std_msgs::String color;
          color.data="red";
          pub_color.publish(color);        
        }
        else if(commandString.compare("绿色") == 0)
        {
          std_msgs::String color;
          color.data="green";
          pub_color.publish(color);  
        }
        else if(commandString.compare("蓝色") == 0)
        {
          std_msgs::String color;
          color.data="blue";
          pub_color.publish(color); 
...
int main(int argc, char* argv[])
{
    ...
    string nlu_topic = "/cube_choose";  //default nlu topic
    ...
    pub_color = n.advertise<std_msgs::String>("/cube_choose",20);
