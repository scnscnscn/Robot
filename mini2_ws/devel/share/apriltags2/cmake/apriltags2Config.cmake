...
if("TRUE" STREQUAL "TRUE")
  set(apriltags2_SOURCE_PREFIX /home/bcsh/mini2_ws/src/apriltags2)
  set(apriltags2_DEVEL_PREFIX /home/bcsh/mini2_ws/devel)
  ...
  set(apriltags2_INSTALL_PREFIX /home/bcsh/mini2_ws/install)
...
if(NOT "/home/bcsh/mini2_ws/src/apriltags2/include " STREQUAL " ")
  set(apriltags2_INCLUDE_DIRS "")
  set(_include_dirs "/home/bcsh/mini2_ws/src/apriltags2/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bcsh/mini2_ws/src/apriltags2/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT apriltags2_NUM_DUMMY_TARGETS)
      set(apriltags2_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::apriltags2::wrapped-linker-option${apriltags2_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR apriltags2_NUM_DUMMY_TARGETS "${apriltags2_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::apriltags2::wrapped-linker-option${apriltags2_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND apriltags2_LIBRARIES "${interface_target_name}")
