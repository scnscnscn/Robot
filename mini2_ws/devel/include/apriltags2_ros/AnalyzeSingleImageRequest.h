...
bool operator==(const ::apriltags2_ros::AnalyzeSingleImageRequest_<ContainerAllocator1> & lhs, const ::apriltags2_ros::AnalyzeSingleImageRequest_<ContainerAllocator2> & rhs)
{
