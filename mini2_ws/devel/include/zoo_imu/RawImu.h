// Generated by gencpp from file zoo_imu/RawImu.msg
// DO NOT EDIT!


#ifndef ZOO_IMU_MESSAGE_RAWIMU_H
#define ZOO_IMU_MESSAGE_RAWIMU_H
...
struct RawImu_
{
  ...
  typedef boost::shared_ptr< ::zoo_imu::RawImu_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::zoo_imu::RawImu_<ContainerAllocator> const> ConstPtr;

}; // struct RawImu_

typedef ::zoo_imu::RawImu_<std::allocator<void> > RawImu;

typedef boost::shared_ptr< ::zoo_imu::RawImu > RawImuPtr;
typedef boost::shared_ptr< ::zoo_imu::RawImu const> RawImuConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::zoo_imu::RawImu_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::zoo_imu::RawImu_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::zoo_imu::RawImu_<ContainerAllocator1> & lhs, const ::zoo_imu::RawImu_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::zoo_imu::RawImu_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::zoo_imu::RawImu_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::zoo_imu::RawImu_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::zoo_imu::RawImu_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::zoo_imu::RawImu_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::zoo_imu::RawImu_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::zoo_imu::RawImu_<ContainerAllocator> >
{
  ...
  static const char* value(const ::zoo_imu::RawImu_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3bc0ea37781da51aULL;
  static const uint64_t static_value2 = 0xd41a6868ff62faa9ULL;
};

template<class ContainerAllocator>
struct DataType< ::zoo_imu::RawImu_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::zoo_imu::RawImu_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::zoo_imu::RawImu_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::zoo_imu::RawImu_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::zoo_imu::RawImu_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // ZOO_IMU_MESSAGE_RAWIMU_H
